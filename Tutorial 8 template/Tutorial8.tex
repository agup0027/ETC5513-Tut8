...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{worldwide\_cases }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"data/worldwidecases.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{barbados\_cases }\OtherTok{\textless{}{-}}\NormalTok{ worldwide\_cases }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(countriesAndTerritories}\SpecialCharTok{==}\StringTok{"Barbados"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(month,year) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{n =} \FunctionTok{sum}\NormalTok{(cases))}

\NormalTok{barbados\_cases }\SpecialCharTok{\%\textgreater{}\%}
...
\includegraphics{Tutorial8_files/figure-latex/unnamed-chunk-3-1.pdf}
